...
return (
  <div className="w-full max-w-6xl mx-auto p-6">
    ...
    {/* Message Alert */}
    {message && (
      <div className={`p-4 rounded-lg text-sm font-medium mb-4 ${isError
              ...
              <tr key={product._id} className="border-b border-gray-200 hover:bg-gray-50 transition">
                ...
                <td className="px-4 py-3 text-center">
                  <button
                    ...
                    className={`p-2 rounded-md transition inline-flex items-center justify-center ${deletingId === product._id
